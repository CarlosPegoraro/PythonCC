...
tabela = pd.read_csv("D:/5_Programação/IntensivaoPython/class/class4/assets/barcos_ref.csv")
print(tabela)
...
nova_tabela = pd.read_csv("D:/5_Programação/IntensivaoPython/class/class4/assets/novos_barcos.csv")
print(nova_tabela)
